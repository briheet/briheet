...
const ProfileImage = () => {
  return (
    <>
      ...
      <div className="absolute top-54 left-[28rem] flex flex-col">
        <h1 className="text-3xl font-bold text-foreground mb-2" style={{ fontFamily: 'Kablammo, cursive' }}>
          Briheet Singh Yadav
        </h1>
        <p className="text-lg text-muted-foreground mb-4" style={{ fontFamily: 'Indie Flower, cursive' }}>
